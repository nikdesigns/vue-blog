    ...
    <main class="lg:relative">
      ...
      >
        <div class="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
          <h1
            class="text-4xl tracking-tight  text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl"
          >
            <span class="block xl:inline font-thin">Data to enrich your</span>
            <!-- space -->
            <span class="block text-indigo-600 xl:inline font-normal">
              online business</span
            >
          </h1>
          <p
            class="mt-3 max-w-md mx-auto text-lg text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl font-light"
          >
