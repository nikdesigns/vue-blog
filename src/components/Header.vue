                          ...
                          <ul class="mt-5 space-y-6">
                            <li class="flow-root">
                              ...
                              >
                                <svg
                                  class="flex-shrink-0 h-6 w-6 text-gray-400"
                                  x-description="Heroicon name: outline/information-circle"
                                  xmlns="http://www.w3.org/2000/svg"
                                  fill="none"
                                  viewBox="0 0 24 24"
                                  stroke="currentColor"
                            ...
                            <li class="flow-root">
                              ...
                              >
                                <svg
                                  class="flex-shrink-0 h-6 w-6 text-gray-400"
                                  x-description="Heroicon name: outline/office-building"
                                  xmlns="http://www.w3.org/2000/svg"
                                  fill="none"
                                  viewBox="0 0 24 24"
                                  stroke="currentColor"
                            ...
                            <li class="flow-root">
                              ...
                              >
                                <svg
                                  class="flex-shrink-0 h-6 w-6 text-gray-400"
                                  x-description="Heroicon name: outline/newspaper"
                                  xmlns="http://www.w3.org/2000/svg"
                                  fill="none"
                                  viewBox="0 0 24 24"
                                  stroke="currentColor"
                            ...
                            <li class="flow-root">
                              ...
                              >
                                <svg
                                  class="flex-shrink-0 h-6 w-6 text-gray-400"
                                  x-description="Heroicon name: outline/briefcase"
                                  xmlns="http://www.w3.org/2000/svg"
                                  fill="none"
                                  viewBox="0 0 24 24"
                                  stroke="currentColor"
                          ...
                          <ul class="mt-5 space-y-6">
                            ...
                            <li class="flow-root">
                              ...
                              >
                                <svg
                                  class="flex-shrink-0 h-6 w-6 text-gray-400"
                                  x-description="Heroicon name: outline/desktop-computer"
                                  xmlns="http://www.w3.org/2000/svg"
                                  fill="none"
                                  viewBox="0 0 24 24"
                                  stroke="currentColor"
              ...
              <div class="mt-6 sm:mt-8">
                <nav>
                  ...
                  <div class="mt-8 text-base">
                    ...
                    >
                      View all products <span aria-hidden="true">→</span></a
                    >
                  </div>
                </nav>
              </div>
